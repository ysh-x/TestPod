...
public class NLPDriver {
	...
	private static List<Integer> sentenceCount = new ArrayList<Integer>();
	static List<Pair<String, String>> finalStructure = new ArrayList<Pair<String, String>>();
	static List<Pair<Integer, Integer>> answerCount = new ArrayList<Pair<Integer, Integer>>();
	...
	public static NLPBean generateSkeleton() throws InvalidFormatException, IOException {
		...
		for (String answer : answers) {
			...
			List<ArrayList<String>> tokenizedAns = new ArrayList<ArrayList<String>>();
			...
			List<Pair<String,String>> tempAns = new ArrayList<Pair<String, String>>();
